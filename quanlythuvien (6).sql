...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 09, 2022 lúc 02:33 PM
...
(8, 19, 4, 'taicho', '2022-03-22', 'muon', '0000-00-00', ''),
...
--
ALTER TABLE `muontra`
  MODIFY `ID_MuonTra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `vitri`
  MODIFY `MaVT` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
