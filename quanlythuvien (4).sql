...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 02, 2022 lúc 05:54 AM
...
CREATE TABLE `muontra` (
  ...
  `KieuMuon` text COLLATE utf8mb4_vietnamese_ci NOT NULL,
...
INSERT INTO `muontra` (`ID_MuonTra`, `SoThe`, `MaCaBiet`, `KieuMuon`, `NgayMuon`, `NguoiChoMuon`, `HanTra`, `Loai`, `NgayTra`, `NguoiNhan`) VALUES
(2, 1, 333, 'demve', '2022-03-01', 'present', '2022-03-02', '0', '0000-00-00', '0'),
(3, 1, 654, 'demve', '2022-03-01', 'present', '2022-03-02', '0', '0000-00-00', '0'),
(4, 1, 776, 'demve', '2022-03-01', 'present', '2022-03-02', '0', '0000-00-00', '0'),
(5, 1, 333, '', '2022-03-02', 'present', '0000-00-00', 'Muon', '0000-00-00', ''),
(6, 1, 564, '', '2022-03-02', 'present', '0000-00-00', 'Muon', '0000-00-00', ''),
(7, 1, 1, '', '2022-03-02', 'present', '2022-03-10', 'tra', '2022-03-02', 'present'),
(8, 1, 2, '', '2022-03-02', 'present', '2022-03-10', 'tra', '2022-03-02', 'present'),
(9, 1, 3, '', '2022-03-02', 'present', '2022-03-10', 'tra', '2022-03-02', 'present');
...
(1, 6, 0, '', '2022-03-01', 'present', '', ''),
(2, 6, 0, '', '2022-03-01', 'present', '', ''),
(3, 6, 0, '', '2022-03-01', 'present', '', ''),
(4, 6, 0, '', '2022-03-01', 'present', '', ''),
(5, 6, 0, '', '2022-03-01', 'present', '', '');
...
--
ALTER TABLE `muontra`
  MODIFY `ID_MuonTra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `phieunhap`
  MODIFY `IDNhap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tlchitiet`
  MODIFY `MaCaBiet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
