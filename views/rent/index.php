...
<div class="container-fluid" style="padding-top:20px">
    ...
    <table class="table table-striped bg-white rounded shadow-sm  table-hover">
        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <a name="" id="" class="btn btn-info" href="index.php?controller=rent&action=add" role="button" style="margin-bottom:10px;margin-right:20px;width:100px;">Mượn tài liệu</a>
